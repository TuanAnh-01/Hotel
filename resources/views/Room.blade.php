<x-app-layout>
    ...
    <body>
        ...
        <section class="rooms spad">
            ...
            @foreach($room as $r)
                <div class="row">
                    <div class="col-lg-6 p-0 order-md-2 col-md-6">
                        <div class="room__pic__slider owl-carousel">
                            <div class="room__pic__item set-bg" data-setbg="images/{{ $r->images }}"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 p-0 order-md-1 col-md-6">
                        <div class="room__text">
                            <h3>{{ $r->name }}</h3>
                            <h2><sup>$</sup>{{ $r->Price }}<span>/day</span></h2>
                            <ul>
                                <li><span>Capacity:</span>{{ $r->capacity }}</li>
                                <li><span>Services:</span>{{ $r->services }}</li>
                                <li ><span>Status:</span>{{ $r->status }}</li>
                            </ul>
                        @if($r->status  == 'Active' )
                            <a href="{{ route('Booking.show', $r->id) }}">View Details</a>
                        @else
                            <p style="color: red">The room is already booked<p>
                        @endif
                        </div>
                    </div>
            ...
            {{ $room->links('vendor.pagination.tailwind') }}
                {{-- <div class="row">
                    <div class="col-lg-12">
