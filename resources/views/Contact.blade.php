<x-app-layout>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/Messege.css" type="text/css">
    ...
    <div class="booking-form-wrapper" >
        ...
        <div class="open-booking-button">
            <div id="container">
                <div id="success-box">
                  ...
                  <div class="message"><h1 class="alert ">Success!</h1><p>yay, email sent successfully.</p></div>
                  <button class="button-box"><h1 class="green success">continue</h1></button>
                </div>
            </div>
        </div>
        ...
        <div class="open-booking-button">
            <div id="container">
                <div id="error-box">
                  ...
                  <button class="button-box"><h1 class="red success">try again</h1></button>
                </div>
        @endif
              </div>
        </div>
        ...
        <script>
          ...
          $('.open-booking-button').slideDown(function() {
            $('.booking-form-wrapper').fadeIn();
          });
          
          // Bấm vào button "Đóng" hoặc bên ngoài form booking để đóng form
          $('.booking-form-wrapper, .success').click(function(event) {
            if (event.target == this || $(event.target).hasClass('success')) {
