<x-app-layout>
    ...
    <body>
        ...
        <div class="room-details-slider">
            <div class="container">
                <div class="room__details__pic__slider owl-carousel" style="position: static">
                    <div class="room__details__pic__slider__item set-bg" data-setbg="../images/{{ $showroom->images }}"></div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="room__details__content">
                            ...
                            <div class="room__details__title booking-form-container">
                                <h2>{{ $showroom->name }}</h2>
                                {{-- href="{{ route('Booking.edit', $showroom->id) }}" --}}
                                <button  class="primary-btn open-booking-button">Booking Now</button>
                                <div class="booking-form-wrapper" >
                                    <form class="booking-form" action="{{ route('Booking.keySession') }}" method="post">
                                                  ...
                                                  <div class="booking-form mt-5 mb-5" >
                                                      ...
                                                      @csrf
                                                          <div class="form-group input-not-empty">
                                                              <input class="form-control" type="text" name="name" value="{{$showroom->name}} " readonly>
                                                          ...
                                                          <div class="row">
                                                              <div class="col-md-4">
                                                                  <div class="form-group input-not-empty" >
                                                                      <input class="form-control" type="text" name="room_id" value="{{$showroom->id}} " readonly>
                                                                      <span class="select-arrow"></span>
                                                                      <span class="form-label">Rooms_id</span>
                                                                  </div>
                                                              </div>
                                                              <div class="col-md-4">
                                                                  <div class="form-group input-not-empty">
                                                                      <span class="form-label">Capacity</span>
                                                                      <input class="form-control " type="text" name="capacity"  placeholder="Max {{$showroom->capacity}}" required>
                                                              ...
                                                              <div class="col-md-4">
                                                                  <div class="form-group input-not-empty">
                                                                      <input class="form-control" type="text" name="Price" value="{{$showroom->Price}}" readonly>
                                                                      <span class="select-arrow"></span>
