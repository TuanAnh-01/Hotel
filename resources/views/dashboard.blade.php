...
<body>
    ...
    <!-- Hero Section Begin -->
    @foreach($banner as $b)
    <section class="hero spad set-bg" data-setbg="images/{{ $b->images }}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero__text">
                        <h5>{{ $b->title }}</h5>
                        <h2>{{ $b->summarytitle }}</h2>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 p-0">
                    <div class="home__room__item set-bg" data-setbg="images/{{ $r->images }}">
                        <div class="home__room__title">
                            <h4>{{ $r->name }}</h4>
                            <h2><sup>$</sup>{{ $r->Price }}<span>/day</span></h2>
                        </div>
                        <a href="{{ route('Booking.show', $r->id) }}">Booking Now</a>
                    </div>
                </div>
                @endforeach
                {{-- <div class="col-lg-3 col-md-6 col-sm-6 p-0">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="chooseus__text">
                        ...
                        <a href="{{ route('Booking.index') }}" class="primary-btn">Booking Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="gallery spad">
        ...
        <div class="gallery__slider owl-carousel">
            @foreach($images as $i)
            <div class="gallery__item small__item set-bg" data-setbg="images/{{ $i->images }}"></div>
            @endforeach
    ...
    <section class="latest-blog spad">
        <div class="container">
            ...
            <div class="col-md-6">
                <div class="row mb-5">
                    <div class="col-md-6 p-0 order-lg-1  order-md-1">
                        <div class="latest__blog__pic set-bg" data-setbg="images/{{ $e->images }}"></div>
                    </div>
                    <div class="col-md-6 p-0 order-lg-2  order-md-2 mb-1">
                        <div class="latest__blog__text">
                            <div class="label">{{ $e->name }}</div>
                            <h5>{{ $e->venue }}</h5>
                            <p><i class="fa fa-eye"></i> Lượt truy cập : {{ $e->views_count }}</p>
                            <p><i class="fa fa-user-circle"></i>Number of participants : {{ $e->Capacity }}</p>
                            <a href="{{ route('Event.show', $e->id) }}">View event</a>
                        </div>
                    </div>
                </div>
